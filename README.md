Para poder ejecutar este ejemplo debes montar una instancia de Zookeeper y kafka

[https://jd-bots.com/2021/08/14/start-zookeeper-and-kafka-in-windows-os/](URL "Fuente")
...
Descompresión
Con el programa open source 7Zip podremos descomprimirlo , os recomiendo hacerlo en una carpeta donde la ruta resultante no sea demasiado larga, ya que esto podría dar problemas
Tambien podrías tener problemas si tu variable %JAVA_HOME% tiene espacios en blanco tenlo en cuenta
